...
| `max-output-tokens` | `32768` | Deprecated and ignored; the coding agent applies its own per-request output cap (32000 for Sonnet 4.6 and Haiku 4.5 in observed runs) |
